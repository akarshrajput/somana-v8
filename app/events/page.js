...
export const metadata = {
  title: "Events — Somana",
  description:
    "Explore upcoming events by Somana — creator meetups, storytelling nights, and podcast live sessions.",
  alternates: { canonical: `${BASE_URL}/events` },
  openGraph: {
    title: "Events — Somana",
    description: "Explore upcoming events by Somana — creator meetups, storytelling nights, and podcast live sessions.",
    url: `${BASE_URL}/events`,
    type: "website",
    ...
    <div className="flex flex-col items-center my-32">
      <div className="w-full max-w-[1200px] px-4">
        ...
        <p className="text-stone-600 mb-8 max-w-2xl">
          Creator meetups, storytelling nights, and podcast live recording sessions — all on Somana. 
          We bring our community of writers, podcasters, and listeners together both online and offline.
        </p>
        ...
        <section className="mt-12 pt-6 border-t border-stone-200 max-w-4xl">
          ...
          <p className="text-stone-500 text-sm leading-relaxed">
            Somana events are designed to bring together the world's growing community of independent content creators. 
            Whether you are a writer wanting to share your work with an audience, or a podcaster seeking collaboration 
            opportunities, our events provide a welcoming and supportive environment. 
          ...
          <p className="text-stone-500 text-sm leading-relaxed mt-3">
            ...
            in select cities worldwide. Stay tuned for announcements about upcoming events by following our social media 
