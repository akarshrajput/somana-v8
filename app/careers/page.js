...
export const metadata = {
  ...
  description:
    "Join the Somana team. We're looking for passionate creators, engineers, and storytellers to help build a leading global creative content platform for stories, podcasts, and notes.",
  alternates: { canonical: `${BASE_URL}/careers` },
  openGraph: {
    title: "Careers at Somana",
    description:
      "Join the Somana team. Build a leading global creative content platform.",
  ...
  twitter: {
    card: "summary",
    title: "Careers at Somana",
    description: "Join the Somana team and build a global creative content platform.",
    ...
    <div className="flex flex-col items-center my-32">
      <div className="w-full max-w-[1200px] px-4">
        ...
        <p className="text-stone-600 mb-8 max-w-2xl">
          We&apos;re building a leading global creative content platform. Join us on our mission to redefine 
          how digital stories, notes, and audio podcasts are shared, discovered, and celebrated.
        </p>
