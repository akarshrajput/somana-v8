...
export const metadata = {
  ...
  description:
    "Discover the top creators on Somana. Explore stories, podcasts, and notes from the world's most talented independent voices and storytellers.",
  alternates: { canonical: `${BASE_URL}/creators` },
  openGraph: {
    title: "Top Creators on Somana",
    description:
      "Explore stories, podcasts, and notes from the world's most talented independent voices.",
  ...
  twitter: {
    ...
    title: "Top Creators on Somana",
    description: "Explore stories, podcasts, and notes from the world's most talented independent voices.",
    ...
    <div className="flex flex-col items-center my-32">
      <div className="w-full max-w-[600px] px-4">
        ...
        <p className="text-stone-600 mb-6 text-sm leading-relaxed">
          ...
          Experience Points (XP) by contributing high-quality stories and uploading podcasts. 
        ...
        <section className="mt-12 pt-6 border-t border-stone-200">
          ...
          <p className="text-stone-500 text-sm leading-relaxed">
            ...
            uploading a podcast episode adds to your XP score. The more 
          ...
          <p className="text-stone-500 text-sm leading-relaxed mt-3">
            ...
            or record storytelling podcasts, there is a place for you in our creator community.
          </p>
        </section>
      </div>
    </div>
